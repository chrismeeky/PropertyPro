const generateRandomUser = () => {
	const alphabets = ['jude', 'jane', 'emeka', 'tolu', 'mbakwe', 'halima', 'akpan', 'benjamin', 'musa', 'chidinma'];
    const domains = ['yahoo.com', 'gmail.com', 'hotmail.com','outlook.com', 'icloud.com','cnn.com','mail.com', 'co.uk', 'ymail.com', 'aol.com']
